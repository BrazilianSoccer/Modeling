...
model {
    ...
    for (jogo in 1:num_jogos) {
        // Likelihood
        target += gols_equipe1[jogo] * (log(habilidade[equipe1[jogo]] + home_force) - log(habilidade[equipe2[jogo]])) - ((habilidade[equipe1[jogo]] + home_force) / habilidade[equipe2[jogo]]);
